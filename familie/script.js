...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (motivList) {
        const motive = [
            ...
            "Pentru că mă înveți să fiu puternic(ă).",
            ...
            "Pentru că mă faci să mă simt special(ă).",
            "Pentru că nu te superi pe mine când greșesc.",
            "Pentru că îmi spui mereu că sunt valoros(oasă).",
            "Pentru că mă încurajezi când sunt trist(ă).",
            ...
            "Pentru că îmi amintești să fiu recunoscător(oare).",
            ...
            "Pentru că mă înveți să fiu responsabil(ă).",
            ...
            "Pentru că mă înveți să fiu recunoscător(oare).",
            "Pentru că îți pasă de fiecare detaliu al vieții mele.",
            "Pentru că mă sprijini când sunt slab(ă).",
            ...
            "Pentru că mă înveți să fiu independent(ă).",
            ...
            "Pentru că mă motivezi să fiu mai bun(ă).",
            ...
            "Pentru că mă înveți să fiu recunoscător(oare) pentru tot ce am.",
            ...
            "Pentru că mă înveți să fiu curajos(oasă) și puternic(ă).",
    ...
    if (puzzleContainer) {
        ...
        for (let row = 0; row < gridSize; row++) {
            for (let col = 0; col < gridSize; col++) {
                ...
                piece.style.backgroundSize = "cover";  // Adăugăm background-size: cover
