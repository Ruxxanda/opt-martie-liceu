...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (motivList) {
        const motive = [
            ...
            "Pentru iubirea ei necondiționată", 
            "Pentru grija pe care mi-o poartă",
            "Pentru sacrificiile ei",
            "Pentru sfaturile ei",
            "Pentru răbdarea ei infinită", 
            "Pentru că mă susține în orice", 
            "Pentru mâncarea delicioasă pe care o face", 
            "Pentru vocea ei caldă", 
            "Pentru îmbrățișările ei", 
            "Pentru puterea ei", 
